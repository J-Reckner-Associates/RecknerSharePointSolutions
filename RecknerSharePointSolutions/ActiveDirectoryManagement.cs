...
namespace RecknerSharePointSolutions
{
    ...
    public class ActiveDirectoryManagement
    {
        ...
        private string sDomain = "reckner.com";
        ...
        public bool IsUserExist(string sUserName)
        {
        ...
        {
            PrincipalContext ctx = this.GetPrincipalContext();

            UserPrincipal oUserPrincipal =
               UserPrincipal.FindByIdentity(ctx, sUserName);
        ...
        public List<Principal> AllUsers()
        {
            ...
            if (grp != null)
            {
                foreach (Principal p in grp.GetMembers(false))
                {
                   ...
                   // UserPrincipal up = UserPrincipal.FindByIdentity(ctx, p.SamAccountName);
           ...
           string sUserName, string sPassword, string sGivenName, string sSurname)
        {
            if (!IsUserExist(sUserName))
            {
              ...
              (ContextType.Domain, sDomain, "NewHire", ContextOptions.SimpleBind);

                UserPrincipal oUserPrincipal = new UserPrincipal
                   (oPrincipalContext, sUserName, sPassword, false /*Enabled or not*/);
        ...
        /// <returns>Returns the GroupPrincipal object</returns>
        public GroupPrincipal CreateNewGroup(string sGroupName,
        ...
        {
            PrincipalContext oPrincipalContext = new PrincipalContext
               (ContextType.Domain, sDomain, null, ContextOptions.SimpleBind);
